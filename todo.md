...
- [ ] Проверить, как GitHub Pages выбирает README вместо приложения.
- [ ] Подготовить публикацию без README только если это не ломает исходный ORBIT.
- [ ] Проверить результат и явно документировать ограничение отсутствия backend на GitHub Pages.

- [ ] Добавить опубликованный Manus URL как официальный сайт GitHub-репозитория ORBIT.
- [ ] Настроить GitHub Pages-переход на рабочий Manus ORBIT вместо README.
- [ ] Проверить публичные ссылки GitHub и Manus после связывания.
