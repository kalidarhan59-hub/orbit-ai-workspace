...
export default function Auth() {
  ...
  return <main className="relative grid min-h-screen overflow-hidden bg-[#070b16] text-white lg:grid-cols-[1fr_minmax(420px,0.85fr)]">
    ...
    <section className="relative hidden flex-col justify-between border-r border-white/[0.07] p-10 lg:flex xl:p-16">
      <div className="flex items-center gap-3"><img src="/manus-storage/orbit-logo-avatar_1343d925.png" alt="ORBIT" className="size-10 rounded-xl object-cover shadow-lg shadow-violet-500/20" /><span className="font-semibold tracking-tight">ORBIT</span></div>
