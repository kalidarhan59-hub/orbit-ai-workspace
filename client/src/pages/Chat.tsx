...
import { Bot, CheckCircle2, ChevronDown, Code2, FileAudio, FileImage, FileText, ImagePlus, Loader2, Mic, Paperclip, Plus, Send, Sparkles, Square, X } from "lucide-react";
...
export default function Chat() {
  ...
  const send = trpc.assistant.send.useMutation({
    onSuccess: (result) => {
      ...
      if (result.mode !== "image") setStreamingId(result.assistantMessage?.id ?? null);
    },
    onError: (error) => {
      setPending([]);
